...
const services = () => {
  ...
  return (
    <>
      ...
      <div className="flex h-full w-full place-content-center place-items-center mt-[10vh] flex-col z-20">
        <h1 className="text-center text-6xl flex text-prime">SERVICES</h1>
        <Service
          title={'Ramp Services'}
          content={
